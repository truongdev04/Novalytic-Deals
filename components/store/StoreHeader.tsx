...
export function StoreHeader({
  ...
  return (
    <div className="rounded-xl border border-muted-200 bg-surface-0 p-6 shadow-sm">
      ...
      <div className="mt-5 hidden border-t border-muted-200 pt-5 sm:block">
        <h2 className="font-heading text-sm font-semibold text-brand-950">Short description</h2>
        <RichHtml html={store.description} className="mt-2 text-justify text-sm text-muted-600" />
      </div>
    </div>
  );
}
