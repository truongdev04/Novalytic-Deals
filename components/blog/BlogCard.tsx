...
export function BlogCard({ post }: { post: BlogPost }) {
  return (
    <article className="group overflow-hidden rounded-lg border border-muted-200 bg-surface-0 shadow-sm transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-md">
      ...
      <div className="p-4">
        ...
        <p className="mt-2 line-clamp-2 text-sm text-muted-600">{post.excerpt}</p>
