...
// Same as SingleSelectDropdown, minus the page-scroll lock — for places
// where the surrounding page must stay scrollable while the dropdown is
// open (e.g. long forms). Kept as a separate component so the scroll-lock
// behavior other consumers (CouponForm's Store select, CouponTable's Store
// filter) rely on isn't affected.
export function ScrollableSingleSelectDropdown({
  options,
  value,
  onChange,
  placeholder = "Select...",
