...
// Same as MultiSelectDropdown, minus the page-scroll lock — for places
...
// behavior other consumers rely on isn't affected.
export function ScrollableMultiSelectDropdown({
  options,
  values,
  onChange,
  placeholder = "Select...",
